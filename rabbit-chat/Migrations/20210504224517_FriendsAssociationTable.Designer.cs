...
namespace rabbit_chat.Migrations
{
    ...
    [Migration("20210504224517_FriendsAssociationTable")]
    partial class FriendsAssociationTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rabbit_chat.Models.FriendsUserAssociation", b =>
                {
                    b.Property<int>("FriendsUserAssociationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasKey("FriendsUserAssociationId");

                    b.HasIndex("FirstUserId");

                    b.HasIndex("SecondUserId");

                    b.ToTable("FriendsUserAssociations");
                });
            ...
            modelBuilder.Entity("rabbit_chat.Models.FriendsUserAssociation", b =>
                {
                    b.HasOne("rabbit_chat.Models.RabbitUser", "FirstUser")
                        .WithMany("Friends")
                        .HasForeignKey("FirstUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("rabbit_chat.Models.RabbitUser", "SecondUser")
                        .WithMany("FriendsOf")
