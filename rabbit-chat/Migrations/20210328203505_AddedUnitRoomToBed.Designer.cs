...
namespace rabbit_chat.Migrations
{
    ...
    [Migration("20210328203505_AddedUnitRoomToBed")]
    partial class AddedUnitRoomToBed
    {
            ...
            modelBuilder.Entity("rabbit_chat.Models.ActBed", b =>
                {
                    ...
                    b.HasOne("rabbit_chat.Models.ActRoom", "ActRoom")
                        .WithMany("ActRoomBeds")
                        .HasForeignKey("ActRoomId");

                    b.HasOne("rabbit_chat.Models.ActUnit", "ActUnit")
                        .WithMany()
                    ...
                    b.Navigation("ActRoom");

                    b.Navigation("ActUnit");
                });
