...
COMMENT ON TABLE public."user" IS 'Contains all users and relevant data';
...
--
-- Name: usertoroom usertoroom_user_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.usertoroom
    ADD CONSTRAINT usertoroom_user_id_fk FOREIGN KEY (userid) REFERENCES public."user"(id);
